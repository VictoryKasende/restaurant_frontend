...
const Sidebar = () => (
  <aside className="w-56 min-h-screen bg-gradient-to-b from-pink-600 to-pink-400 text-white fixed left-0 top-0 z-40 flex flex-col shadow-lg">
    <div className="flex items-center justify-center h-20 border-b border-pink-300">
      ...
      <span className="font-bold text-xl">TaborManager</span>
    </div>
    <nav className="flex-1 py-6 space-y-2">
      <a href="/dashboard" className="block px-6 py-3 hover:bg-pink-700 rounded transition">Dashboard</a>
      <a href="/dashboard/menu" className="block px-6 py-3 hover:bg-pink-700 rounded transition">Menu</a>
      <a href="/dashboard/commandes" className="block px-6 py-3 hover:bg-pink-700 rounded transition">Commandes</a>
      <a href="/dashboard/avis" className="block px-6 py-3 hover:bg-pink-700 rounded transition">Avis & Sentiment</a>
      <a href="/dashboard/tables" className="block px-6 py-3 hover:bg-pink-700 rounded transition">Tables</a>
    </nav>
  </aside>
);
